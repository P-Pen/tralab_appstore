...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        if (i < size2) {
            ...
            CollectionsKt.joinTo(CollectionsKt.drop(normalize$FilesKt__UtilsKt.getSegments(), i), sb, (r15 & 2) != 0 ? ", " : str, (r15 & 4) != 0 ? "" : null, (r15 & 8) != 0 ? "" : null, (r15 & 16) != 0 ? -1 : 0, (r15 & 32) != 0 ? "..." : null, (r15 & 64) != 0 ? null : null);
        }
        return sb.toString();
    }
