...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m392containsxj2QHRw(((UShort) obj).m308unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m393indexOfxj2QHRw(((UShort) obj).m308unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m394lastIndexOfxj2QHRw(((UShort) obj).m308unboximpl());
        }
        return -1;
    }
    ...
    public boolean m392containsxj2QHRw(short s) {
        return UShortArray.m312containsxj2QHRw(this.$this_asList, s);
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public UShort get(int i) {
        return UShort.m261boximpl(UShortArray.m316getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-xj2QHRw  reason: not valid java name */
    public int m393indexOfxj2QHRw(short s) {
        return ArraysKt.indexOf(this.$this_asList, s);
    }

    /* renamed from: lastIndexOf-xj2QHRw  reason: not valid java name */
    public int m394lastIndexOfxj2QHRw(short s) {
