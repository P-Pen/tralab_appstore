...
public final class UArraysKt___UArraysJvmKt$asList$3 extends AbstractList<UByte> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m389contains7apg3OU(((UByte) obj).m75unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UByte) {
            return m390indexOf7apg3OU(((UByte) obj).m75unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UByte) {
            return m391lastIndexOf7apg3OU(((UByte) obj).m75unboximpl());
        }
        return -1;
    }
    ...
    public boolean m389contains7apg3OU(byte b) {
        return UByteArray.m79contains7apg3OU(this.$this_asList, b);
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public UByte get(int i) {
        return UByte.m28boximpl(UByteArray.m83getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-7apg3OU  reason: not valid java name */
    public int m390indexOf7apg3OU(byte b) {
        return ArraysKt.indexOf(this.$this_asList, b);
    }

    /* renamed from: lastIndexOf-7apg3OU  reason: not valid java name */
    public int m391lastIndexOf7apg3OU(byte b) {
