        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!kotlin.collections.unsigned.UArraysKt.m432contentEqualskdPth3s(((UByteArray) t).m92unboximpl(), ((UByteArray) t2).m92unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!kotlin.collections.unsigned.UArraysKt.m433contentEqualsmazbYpA(((UShortArray) t).m325unboximpl(), ((UShortArray) t2).m325unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!kotlin.collections.unsigned.UArraysKt.m431contentEqualsctEhBpI(((UIntArray) t).m161unboximpl(), ((UIntArray) t2).m161unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!kotlin.collections.unsigned.UArraysKt.m434contentEqualsus8wMrg(((ULongArray) t).m230unboximpl(), ((ULongArray) t2).m230unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(kotlin.collections.unsigned.UArraysKt.m440contentToStringGBYM_sE(((UByteArray) t).m92unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(kotlin.collections.unsigned.UArraysKt.m442contentToStringrL5Bavg(((UShortArray) t).m325unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(kotlin.collections.unsigned.UArraysKt.m439contentToStringajY9A(((UIntArray) t).m161unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(kotlin.collections.unsigned.UArraysKt.m441contentToStringQwZRm1k(((ULongArray) t).m230unboximpl()));
            } else {
