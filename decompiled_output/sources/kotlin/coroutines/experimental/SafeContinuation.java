...
public final class SafeContinuation<T> implements Continuation<T> {
    ...
    public void resume(T t) {
        while (true) {
            ...
            if (obj == obj2) {
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(RESULT, this, obj2, t)) {
                    return;
                }
            } else if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                throw new IllegalStateException("Already resumed");
            } else {
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), RESUMED)) {
    ...
    public void resumeWithException(Throwable exception) {
        ...
        while (true) {
            ...
            Object obj2 = UNDECIDED;
            if (obj == obj2) {
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(RESULT, this, obj2, new Fail(exception))) {
                    return;
                }
            } else if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                throw new IllegalStateException("Already resumed");
    ...
    public final Object getResult() {
        ...
        Object obj2 = UNDECIDED;
        if (obj == obj2) {
            if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(RESULT, this, obj2, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
