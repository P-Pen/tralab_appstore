...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static boolean m219equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual(jArr, ((ULongArray) obj).m230unboximpl());
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m229containsVKZWuLQ(((ULong) obj).m213unboximpl());
        }
        return false;
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long[] m215constructorimpl(int i) {
        return m216constructorimpl(new long[i]);
    }

    /* renamed from: get-impl  reason: not valid java name */
    public static final long m221getimpl(long[] jArr, int i) {
        return ULong.m170constructorimpl(jArr[i]);
    }

    /* renamed from: set-k8EXiF4  reason: not valid java name */
    public static final void m226setk8EXiF4(long[] jArr, int i, long j) {
        jArr[i] = j;
    }
    ...
    public static ULongIterator m225iteratorimpl(long[] jArr) {
    ...
    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public static boolean m217containsVKZWuLQ(long[] jArr, long j) {
        return ArraysKt.contains(jArr, j);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m218containsAllimpl(long[] jArr, Collection<ULong> elements) {
        boolean z;
        Intrinsics.checkParameterIsNotNull(elements, "elements");
        Collection<ULong> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof ULong) && ArraysKt.contains(jArr, ((ULong) obj).m213unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
