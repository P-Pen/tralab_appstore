...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m927containsVKZWuLQ(uLong.m213unboximpl());
    }
    ...
    public boolean m927containsVKZWuLQ(long j) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m170constructorimpl(getFirst() ^ ULong.m170constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m170constructorimpl(getLast() ^ ULong.m170constructorimpl(getLast() >>> 32)));
    }
