...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static boolean m150equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).m161unboximpl());
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m160containsWZ4Q5Ns(((UInt) obj).m144unboximpl());
        }
        return false;
    }
    ...
    public static final int m152getimpl(int[] iArr, int i) {
    ...
    public static boolean m149containsAllimpl(int[] iArr, Collection<UInt> elements) {
        ...
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof UInt) && ArraysKt.contains(iArr, ((UInt) obj).m144unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
