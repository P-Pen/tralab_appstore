...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m992minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo966plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m993plusLRDsOJo(this.adjustment, d), null);
    }
}
