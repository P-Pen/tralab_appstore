...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1018copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1019copyRFiDyg4(obj, d);
    }
    ...
    public final TimedValue<T> m1019copyRFiDyg4(T t, double d) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1007toStringimpl(this.duration) + ")";
    }
