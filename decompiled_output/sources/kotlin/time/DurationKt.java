...
public final class DurationKt {
    ...
    private static final double m1014timesmvk6XK0(int i, double d) {
        return Duration.m996timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1013timeskIfJnKk(double d, double d2) {
        return Duration.m995timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m969constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
