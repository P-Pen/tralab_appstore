...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark extends TimeMark {
        ...
        public double elapsedNow() {
            return Duration.m992minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public TimeMark mo966plusLRDsOJo(double d) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m993plusLRDsOJo(this.offset, d), null);
        }
    }
