...
public class AppAdapterForActivity extends RecyclerView.Adapter<ViewHolder> {
    ...
    public AppAdapterForActivity(Activity activity, List<App> list) {
        this.mAppList = list;
    }
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup viewGroup, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.etralab.appstoreforandroid.AppAdapterForActivity.1
