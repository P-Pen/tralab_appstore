...
public class SwipeBackLayout extends FrameLayout {
    ...
    public void scrollToFinishActivity() {
        ...
        if ((i2 & 1) != 0) {
            ...
            this.mDragHelper.smoothSlideViewTo(this.mContentView, i3, i);
            invalidate();
        }
        i = 0;
        i3 = intrinsicWidth;
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View view, float f, float f2) {
            ...
            if ((SwipeBackLayout.this.mTrackingEdge & 1) != 0) {
                ...
                int intrinsicWidth = (i3 > 0 || (i3 == 0 && SwipeBackLayout.this.mScrollPercent > SwipeBackLayout.this.mScrollThreshold)) ? width + SwipeBackLayout.this.mShadowLeft.getIntrinsicWidth() + 10 : 0;
                i = 0;
                i2 = intrinsicWidth;
